    ...
    def export_canvas_to_sd(self):
        ...
        if success:
            ...
            messagebox.showinfo("Export Successful",
                              ...
                              f"Copy this file to your SD card as 'moves.txt'")
        else:
...
M2            ; Program end"""
    ...
    def exporter_process_and_save(self, gcode_text):
        """Helper: Process G-code and save to file"""
        ...
        # Ask where to save
        filename = filedialog.asksaveasfilename(
            title="Save SD Card File",
            initialfile=SD_OUTPUT_FILE,
        ...
        filepath = exporter.export_to_file(filename)
